...
clouds('white', 5, 15, [100, 30], [90, 55])
clouds('white', 5, 15, [67, 20], [210, 80])
clouds('white', 5, 15, [100, 30], [350, 65])
tree(1, [210, 170])
tree(1.2, [365, 160])
star(36, 'black', 25 + 1, 3 + 1, [30, 30])  # black star
star(36, 'gold', 25, 3, [30, 30])
house([50, 150], 1)
house([255, 125], 1.5)
